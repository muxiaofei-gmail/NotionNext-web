              ...
              <div className='flex items-center gap-4 justify-end pr-16 lg:pr-0'>
                ...
                {!enableClerk && (
                  <div className='hidden sm:flex gap-4'>
                    <a
                      href={siteConfig('STARTER_NAV_BUTTON_1_URL')}
                      className={`loginBtn ${buttonTextColor} p-2 text-base font-medium hover:opacity-70 hidden`}>
                      {siteConfig('STARTER_NAV_BUTTON_1_TEXT')}
                    </a>
                    <a
                      href={siteConfig('STARTER_NAV_BUTTON_2_URL')}
                      className={`signUpBtn ${buttonTextColor} p-2 rounded-md bg-white bg-opacity-20 px-6 py-3 text-base font-medium duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark`}>
                      {siteConfig('STARTER_NAV_BUTTON_2_TEXT')}
                    </a>
                  </div>
                )}
