...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/logo/xh-white.png', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: '/images/starter/logo/xh-black.png', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
